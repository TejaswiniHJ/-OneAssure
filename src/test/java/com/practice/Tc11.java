...
public class Tc11 {
	...
	public void loginpage() throws IOException
	{
		...
		driver.findElement(By.xpath("(//input[@id='standard-full-width'])[1]")).sendKeys(dat.read("un2"));
		driver.findElement(By.xpath("(//input[@id='standard-full-width'])[2]")).sendKeys(dat.read("pwd2"));
	   ...
	   System.out.println(text);
		//span[@class='MuiTypography-root sub_title font_normal_color errorTextColor MuiTypography-caption']
}
}
